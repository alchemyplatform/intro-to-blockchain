...
On the Sui blockchain, two notable examples are **Talus** and **Atoma Network**. Atoma is developing onchain AI agents capable of acting independently across DeFi protocols, games, and even DAO ecosystems. These agents can reason, observe, and react to smart contract events — acting almost like decentralized AI workers that live onchain. Combined with blockchain’s transparency and immutability, this creates powerful possibilities for **verifiable AI logic** and decentralized agent economies.
